...
class ManualSearchTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.item_input.setPlaceholderText("Item Name (ex: Ash Prime Set)")
        ...
        self.max_rank_input.setPlaceholderText("3/5/10 (default: 10)")
    ...
    def handle_stop_item(self, item_url):
        ...
        self.info_label.setText(f"Viewing interrupted for: {item_url}")
